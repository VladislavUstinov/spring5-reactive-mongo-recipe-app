...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        ...
        log.error("#######");
        log.error("Count unitOfMeasureReactiveRepository: " + unitOfMeasureReactiveRepository.count().block().toString());
        log.error("Count categoryReactiveRepository: " + categoryReactiveRepository.count().block().toString());
        log.error("Count recipeReactiveRepository: " + recipeReactiveRepository.count().block().toString());

        //Flux<UnitOfMeasure> uomFlux = reactiveRepository.findAll();
